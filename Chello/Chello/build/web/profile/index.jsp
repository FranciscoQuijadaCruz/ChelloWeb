         ...
         <nav class="navbar navbar-dark contenedor_nav" id="navbarid" style="background-color: #3973ac; color: white; ">
            ...
            <a class="navbar-brand" href="index.jsp">
             ...
             <div class="dropdown" >
                ...
                <a  class="dropdown-item salir" href="../boards">Inicio</a>
            ...
            <div class="row">
                <div class="col-8" style="float: none;margin: 0 auto;">
                    ...
                    <u>
                        ...
                        <p style="cursor:pointer;" data-toggle="modal" data-target="#exampleModalLong" style="text-decoration:none">Cambiar Nombre</p>
                    ...
                    <u>
                        <!-- Button trigger modal -->
                        <p style="cursor:pointer;" data-toggle="modal" data-target="#exampleModalLong2" style="text-decoration:none;">Cambiar Contrasena</p>
